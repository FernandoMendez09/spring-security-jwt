...
import com.springmc.security.spring_security.controller.security.SimpleGrantedAuthorityJsonCreator;
...
public class JwtValidationFilter extends BasicAuthenticationFilter {
    ...
    protected void doFilterInternal( HttpServletRequest request, HttpServletResponse response, FilterChain chain )
        ...
        if( headerToken == null || !headerToken.startsWith( PREFIX_TOKEN ) ) {
            chain.doFilter( request, response );
            return;
        }
        String token = headerToken.replace( PREFIX_TOKEN, "" );
